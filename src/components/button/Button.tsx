  ...
  return (
    <>
      {isLoading ? (
        ...
        <button
          onClick={onClick}
          className={`m-auto flex items-center justify-center px-5 py-3 text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl text-sm font-medium rounded-lg leading-normal ${className}`}
        >
          {text}
        </button>
      )}
